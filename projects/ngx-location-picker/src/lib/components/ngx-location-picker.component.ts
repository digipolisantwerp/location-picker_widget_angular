  ...
  private addMapGeoJson(label: string, geometryShape: string, geometry: any) {
    ...
    if (this.selectedLocation) {
      if (this.selectedLocation.position) {
        this.selectedLocation.position.wgs84 = this.selectedLocationGeometry.getBounds().getCenter();
      }

      if (this.selectedLocation.location && this.selectedLocation.location.position) {
        this.selectedLocation.location.position.wgs84 = this.selectedLocationGeometry.getBounds().getCenter();
      }
